...
by this repository's Go CLI), so the container startup can no longer shell
out to `cobbler import ...`. This performs the equivalent call directly
against cobblerd's XML-RPC API instead.
"""
